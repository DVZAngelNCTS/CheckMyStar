...
-- ============================================================
-- Insertion des critères (Criterion) avec explications
-- ============================================================
INSERT INTO dbo.Criterion ([Description], [BasePoints], [explanation])
SELECT x.[Description], x.[BasePoints], x.[explanation]
FROM (
    VALUES
    (N'Surface totale minimum (cuisine et coin cuisine compris) du logement meublé hors salle d''eau et toilettes', 5, N'Ne sont prises en compte que les superficies existantes sous une hauteur de plafond de 1,80m. Une pièce d''habitation doit comporter un ouvrant sur l''extérieur. Pour les catégories 1*,2* et 3* seulement, et pour les logements T2 et plus, les surfaces habitables requises peuvent être globalisées (réparties différemment par pièce) hors sanitaires dans la limite de 7m² minimum par pièce.'),
    (N'Surface totale majorée', 1, N'Bonification de 1 point par tranche de 20 % de surface supplémentaire (de 1 à 5 points). Ne sont prises en compte que les superficies existantes sous une hauteur de plafond de 1,80m. Une pièce d''habitation doit comporter un ouvrant sur l''extérieur. Le critère peut être validé indépendamment du précédent.'),
    (N'Prise de courant libre dans chaque pièce d''habitation', 1, NULL),
    (N'Tous les éclairages du logement fonctionnent et sont en bon état', 3, NULL),
    (N'Mise à disposition d''un téléphone privatif à l''intérieur du logement', 1, N'Téléphone en commun non accepté. Sauf impossibilité technique (ex : zones blanches justifiées), alors le critère est non applicable.'),
    (N'Accès internet par un réseau local sans fil (WiFi) ', 2, NULL),
    (N'Accès internet filaire avec câble fourni ', 2, NULL),
    (N'Télévision à écran plat avec télécommande', 2, NULL),
    (N'Accès à des chaînes supplémentaires à l''offre de la TNT', 2, NULL),
    (N'Possibilité d''accéder à au moins deux chaînes internationales', 1, NULL),
    (N'Radio', 2, NULL),
    (N'Enceinte connectée', 1, NULL),
    (N'Mise à disposition d''un système de lecture de vidéos', 2, NULL),
    (N'Occultation opaque : extérieure ou intérieure dans chaque pièce comportant un couchage principal', 3, NULL),
    (N'Le logement est équipé de double vitrage', 3, NULL),
    (N'Existence d''un système de chauffage en état de fonctionnement', 5, NULL),
    (N'Existence d''un système de climatisation et / ou de rafraîchissement d''air en état de fonctionnement', 3, NULL),
    (N'Machine à laver le linge pour les logements de 4 personnes et plus', 3, N'Pour les catégories 1 et 2 *, équipement pouvant être commun à plusieurs logements, avec accès indépendant, libre et gratuit. Pour les catégories 3, 4 et 5 étoiles, lave-linge privatif obligatoire - tolérance dans un local privatif extérieur au logement.'),
    (N'Sèche-linge électrique pour les logements de 6 personnes et plus', 2, N'Pour les catégories 1, 2 et 3 étoiles, équipement pouvant être commun à plusieurs logements avec accès indépendant et accessible librement et gratuitement. Pour les catégories 4 et 5 étoiles, sèche-linge privatif obligatoire - tolérance dans un local privatif extérieur au logement. Sauf exception justifiée par le climat (DROM-COM), alors le critère est non applicable.'),
    (N'Etendoir ou séchoir à linge à l''intérieur du logement', 2, NULL),
    (N'Ustensiles de ménage appropriés au logement (minimum : un seau et un balai à brosse avec serpillière ou un balai de lavage à frange avec seau et presse, aspirateur ou équipement équivalent)', 3, NULL),
    (N'Fer et table à repasser', 2, NULL),
    (N'Placards ou éléments de rangement dans le logement', 3, NULL),
    (N'Placards ou éléments de rangement dans chaque pièce d''habitation', 3, N'Obligatoire dans chaque pièce d''habitation pour les catégories 3*, 4* et 5*.'),
    (N'Présence d''une table et d''assises correspondant à la capacité d''accueil du logement', 4, NULL),
    (N'Présence d''un canapé ou fauteuil(s) adapté(s) à la capacité d''accueil', 3, N'Le critère devient non applicable s''il n''y a pas de séjour.'),
    (N'Présence d''une table basse', 1, N'Le critère devient non applicable dans le cas de studios.'),
    (N'Respect des dimensions du (ou des) lit(s)', 4, N'Tolérance pour : - lits superposés (80cmx190cm) - lits jumeaux ou lits gigogne (80cmx190cm) pouvant être assemblés en lit double de 160 cm - canapé-lits convertibles (130cmx190cm) - uniquement pour les studios de catégorie 1* et 2* - lits escamotables pour les studios (toutes catégories)'),
    (N'Matelas haute densité et / ou avec une épaisseur de qualité', 2, N'La densité doit être supérieure à 30 kg/m3 ou équivalent. L''épaisseur doit être minimum de 21 cm.'),
    (N'Présence d''oreiller(s) en quantité suffisante', 2, N'Un oreiller par personne pour les catégories 1* et 2*. Deux oreillers par personne pour les catégories 3*, 4* et 5*.'),
    (N'Deux couvertures ou une couette par lit - couette obligatoire pour les catégories 3*, 4* et 5*', 2, N'Les plaids sont autorisés pour valider le critère dans les DROM-COM.'),
    (N'Matelas et oreillers protégés par des alaises ou des housses amovibles', 2, NULL),
    (N'Eclairage en-tête de lit par personne avec interrupteur individuel', 2, NULL),
    (N'Interrupteur ou système de commande de l''éclairage central près du lit', 2, NULL),
    (N'Présence d''une prise de courant libre située près du lit', 1, NULL),
    (N'Présence d''une table de chevet par personne', 2, NULL),
    (N'Une salle d''eau privative dans un espace clos et aéré intérieur au logement', 2, NULL),
    (N'Une salle d''eau privative avec accès indépendant dans un espace intérieur au logement', 3, NULL),
    (N'Présence d''une salle d''eau ainsi équipée : un lavabo avec eau chaude, une douche et / ou une baignoire (équipée d''une douchette) avec pare-douche ; une baignoire et une douche', 3, NULL),
    (N'Présence d''une salle d''eau ainsi équipée : un lavabo avec eau chaude, une douche (dimensions supérieures au standard) et / ou une baignoire (équipée d''une douchette) avec pare-douche (dimensions supérieures au standard) ; une baignoire et une douche', 2, N'Dimension douche standard = 80 cm x 80 cm. Dimensions baignoire standard = 170 cm x 75 cm.'),
    (N'Un WC (avec cuvette, abattant, chasse d''eau, dérouleur et poubelle) privatif intérieur au logement', 2, N'Toilette sèche acceptée.'),
    (N'Un WC (avec cuvette, abattant, chasse d''eau, dérouleur et poubelle) privatif intérieur au logement indépendant de la salle d''eau', 2, N'Toilette sèche acceptée.'),
    (N'Une deuxième salle d''eau privative dans un espace clos et aéré intérieur au logement avec accès indépendant', 5, N'Pour les logements de moins de 7 personnes, ce critère est non applicable en 1,2,3,4* Pour les logements de moins de 5 personnes, ce critère est non applicable en 5*. Si toutes les chambres sont équipées de salles d''eau, alors le critère est validé. Le critère peut être validé si cette deuxième salle d''eau n''a pas d''accès indépendant; uniquement si la première salle d''eau (jusqu''à 6 personnes) a bien un accès indépendant.'),
    (N'Présence d''une salle d''eau supplémentaire ainsi équipée : un lavabo avec eau chaude, une douche et / ou une baignoire (équipée d''une douchette) avec pare-douche ; une baignoire et une douche', 3, N'Pour les logements de moins de 7 personnes, ce critère est non applicable en 1,2,3,4* Pour les logements de moins de 5 personnes, ce critère est non applicable en 5*.'),
    (N'Un WC supplémentaire (avec cuvette, abattant, chasse d''eau, dérouleur et poubelle) privatif intérieur au logement', 2, N'Toilette sèche acceptée. Pour les logements de moins de 7 personnes, ce critère est non applicable en 1,2,3,4* Pour les logements de moins de 5 personnes, ce critère est non applicable en 5*.'),
    (N'Deux points lumineux dont un sur le lavabo', 2, NULL),
    (N'Présence de produits d''accueil', 3, NULL),
    (N'Une prise de courant libre à proximité du miroir', 2, NULL),
    (N'Patère(s) ou porte-serviettes', 1, NULL),
    (N'Sèche-serviettes électrique', 2, NULL),
    (N'Miroir de salle de bain', 2, NULL),
    (N'Miroir en pied', 2, NULL),
    (N'Tablette sous miroir, plan vasque ou étagère proche du miroir', 2, NULL),
    (N'Espace(s) de rangement supplémentaire(s)', 2, NULL),
    (N'Sèche-cheveux électrique en nombre suffisant', 1, N'Un deuxième sèche-cheveux est exigé dans le logement à partir de 7 personnes.'),
    (N'Evier avec robinet mélangeur ou mitigeur', 3, NULL),
    (N'Nombre de foyers respectés', 3, N'Pour les exigences d''une plaque à 4 foyers, si le logement est équipé d''une plaque à induction ou vitrocéramique à 3 foyers, alors le critère est réputé acquis.'),
    (N'Plaque vitrocéramique, à induction ou à gaz', 2, NULL),
    (N'Pour un mini-four', 3, NULL),
    (N'Four à micro-ondes', 2, NULL),
    (N'Ventilation ou ventilation mécanique contrôlée', 4, N'Il est entendu par "ventilation" une aération naturelle dans la cuisine ou le coin cuisine.'),
    (N'Hotte aspirante', 2, NULL),
    (N'Quantité de vaisselle de table non dépareillée minimum par personne : 2 verres à eau, 1 verre à vin, 2 assiettes plates, 2 assiettes creuses, 2 assiettes à dessert, 2 grandes cuillères, 2 petites cuillères, 2 couteaux, 2 fourchettes, 2 bols, 2 tasses ou mugs', 3, NULL),
    (N'Vaisselle supplémentaire : 1 coupe à champagne, 1 verre à apéritif par personne', 1, NULL),
    (N'Équipement minimum pour la préparation des repas : 1 saladier, 1 plat allant au four, 2 casseroles, 1 poêle, 1 fait-tout, 1 tire-bouchon, 1 décapesculer, 1 paire de ciseaux, 1 planche à découper, 1 couteau à pain, 1 passoire, 1 couvercle, 1 essoreuse à salade, 1 moule à tarte et/ou moule à gâteau, 1 ouvre-boîte, 1 économe, 1 dessous de plat, 1 verre doseur, 1 louche, 1 écumoir, 1 spatule, 1 fouet', 3, NULL),
    (N'Au moins deux équipements de petit-électroménager', 2, NULL),
    (N'Autocuiseur ou cuir-vapeur ou robot de cuisine multifonctions', 3, NULL),
    (N'Cafetière', 2, NULL),
    (N'Machine à expresso', 2, NULL),
    (N'Bouilloire', 1, NULL),
    (N'Grille-pain', 1, NULL),
    (N'Lave-vaisselle pour les logements à partir de 2 personnes', 2, NULL),
    (N'Lave-vaisselle de 6 couverts ou plus pour les logements à partir de 4 personnes', 2, NULL),
    (N'Réfrigérateur avec compartiment conservateur', 4, N'110 litres pour deux personnes, 10 litres en plus par occupant supplémentaire.'),
    (N'Présence d''un congélateur ou compartiment congélateur', 2, NULL),
    (N'Poubelle fermée avec couvercle', 1, NULL),
    (N'Pour accéder au 4ème étage à partir du rez-de-chaussée', 4, N'Sauf contrainte locale ou architecturale. Si le logement est situé en rez-de-chaussée, alors lorsque le critère est obligatoire il devient non applicable. Si le logement est situé entre le 1er et 3ème étage, alors lorsque le critère est obligatoire il devient optionnel.'),
    (N'Pour accéder au 3ème étage à partir du rez-de-chaussée', 4, N'Sauf contrainte locale ou architecturale. Pour les catégories 1° et 2°, les points se cumulent avec ceux du critère précédent. Si le logement est situé en rez-de-chaussée, alors lorsque le critère est obligatoire il devient non applicable. Si le logement est situé entre le 1er et 2ème étage, alors lorsque le critère est obligatoire il devient optionnel.'),
    (N'Emplacement(s) à proximité', 4, N'En cas de contrainte locale le critère est non applicable.'),
    (N'Emplacement(s) privatif(s)', 3, N'En cas de contrainte locale le critère est non applicable.'),
    (N'Garage ou abri couvert privatif', 2, NULL),
    (N'Logement avec balcon, loggia ou veranda (3m² minimum)', 2, N'Cour intérieure aménagée tolérée.'),
    (N'Logement avec terrasse ou jardin privé (8m² minimum)', 3, N'200m² minimum quand il est commun à d''autres logements.'),
    (N'Logement avec parc ou jardin (50m² minimum)', 2, NULL),
    (N'Présence de mobilier de jardin privatif propre et en bon état', 2, NULL),
    (N'Mise à disposition d''une planche extérieure et/ou d''un barbecue extérieur', 2, NULL),
    (N'Un équipement léger de loisirs, détente ou sport, dédié au logement', 2, N'Accès gratuit en propriété pleine ou copropriété.'),
    (N'Un équipement aménagé de loisirs, détente ou sport, dédié au logement', 2, N'Accès gratuit en propriété pleine ou copropriété.'),
    (N'Piscine extérieure ou intérieure', 2, N'Accès gratuit en propriété pleine ou copropriété.'),
    (N'Piscine extérieure ou intérieure chauffée', 2, N'Accès gratuit en propriété pleine ou copropriété.'),
    (N'Existence de rangement(s) pour équipement sportif', 1, N'Accès gratuit en propriété pleine ou copropriété. NA si localisation non adaptée.'),
    (N'Logement avec vue paysagère (vue mer, montagne, plaine ou zone urbaine)', 2, NULL),
    (N'Logement avec accès immédiat à un environnement offrant la possibilité de faire des activités : nature, culture et sport', 3, N'Accès situé à 1km maximum.'),
    (N'Logement avec accès immédiat aux commerces, services et transports en commun', 3, N'Accès situé à 1km maximum.'),
    (N'Les sanitaires (toilette(s) et salle(s) d''eau) sont propres et en bon état', 5, N'Le sol, le plafond, la paroi de douche (ou rideau de douche) et les murs sont propres et en bon état (absence de moisissures, saletés, traces de calcaire, cheveux...). Absence de carrelage cassé et de revêtement abîmé.'),
    (N'Les sols murs et plafonds sont propres et en bon état', 5, N'Absence de saletés sur les murs, de peintures écaillées, de papier peint abîmé et déchiré, de carrelage cassé, de moquette tâchée, de traces de moisissures...'),
    (N'Le mobilier est propre et en bon état', 5, N'Absence de mobiliers cassés, déboîtés et sales.'),
    (N'La literie est propre et en bon état', 5, N'Ensemble constitué par matelas et sommier. Absence de tâches, de trous, de décoloration.'),
    (N'La cuisine ou coin cuisine et les équipements sont propres et en bon état', 5, N'Absence d''équipements cassés, déboîtés et sales. Absence de saletés sur les murs, de peintures écaillées, de papier peint abîmé et déchiré, de carrelage cassé, de traces de moisissures...'),
    (N'Mise à disposition de brochures d''informations locales et touristiques en français et dans au moins une langue étrangère', 3, NULL),
    (N'Mise à disposition d''un livret d''accueil', 2, NULL),
    (N'Accueil sur place par le propriétaire ou son représentant', 3, NULL),
    (N'Cadeau de bienvenue à l''arrivée du client', 2, NULL),
    (N'Existence d''une boite à clé ou système équivalent', 2, NULL),
    (N'Draps de lit proposés systématiquement par le loueur', 2, NULL),
    (N'Linge de toilette proposé systématiquement par le loueur', 2, NULL),
    (N'Linge de table', 2, NULL),
    (N'Lits faits à l''arrivée proposés systématiquement par le loueur', 2, NULL),
    (N'Matériel pour bébé à la demande', 2, NULL),
    (N'Service de ménage proposé systématiquement', 2, NULL),
    (N'Présence de produits d''entretien', 2, NULL),
    (N'Adaptateurs électriques', 2, NULL),
    (N'Existence d''un site internet ou d''une page internet dédiée au logement', 2, NULL),
    (N'Existence d''un site internet ou d''une page internet dédiée au logement en une langue étrangère', 1, NULL),
    (N'Animaux de compagnie admis', 2, NULL),
    (N'Informations concernant l''accessibilité sur les supports d''information', 2, NULL),
    (N'Mise à disposition de télécommande de télévision à grosses touches et de couleurs contrastées', 2, NULL),
    (N'Présence d''un siège de douche avec barre d''appui', 2, NULL),
    (N'Présence de WC avec barre d''appui', 2, NULL),
    (N'Largeur de toutes les portes adaptées', 2, NULL),
    (N'Document accessible mis à disposition', 1, N'Si le meublé est labellisé Tourisme et Handicap, le critère est validé.'),
    (N'Obtention du label Tourisme et Handicap', 3, NULL),
    (N'Mise en œuvre d''une mesure de réduction de consommation d''énergie', 3, NULL),
    (N'Mise en œuvre d''une mesure de réduction de consommation d''énergie supplémentaire', 1, N'Les points se cumulent avec ceux du critère précédent.'),
    (N'Borne de recharge pour les véhicules électriques', 2, NULL),
    (N'Mise en œuvre d''une mesure de réduction de consommation d''eau', 3, NULL),
    (N'Mise en œuvre d''une mesure de réduction de consommation d''eau supplémentaire', 1, N'Les points se cumulent avec ceux du critère précédent.'),
    (N'Existence d''un système de tri des déchets dédié au logement', 1, N'Si l''immeuble ou la commune n''a pas mis en place un système de tri sélectif alors le critère est non applicable.'),
    (N'Existence d''un composteur', 1, NULL),
    (N'Sensibilisation des clients sur les actions qu''ils peuvent réaliser lors de leur séjour en matière de respect de l''environnement', 2, NULL),
    (N'Présence de produits d''accueil écologiques dans la salle de bains', 2, NULL),
    (N'Mise à disposition d''au moins deux produits d''entretien respectueux de l''environnement', 1, NULL),
    (N'Obtention d''un label environnemental', 3, N'Les labels autorisés pour valider le critère sont les labels recommandés par l''ADEME.')
) AS x([Description], [BasePoints], [explanation])
WHERE NOT EXISTS (
