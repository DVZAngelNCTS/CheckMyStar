...
- Créez un projet Angular avec ng : `ng new CheckMyStar.Angular --defaults --skip-install --skip-git --no-standalone `.
- Mettez à jour angular.json avec le port.
- Créez le fichier projet (`CheckMyStar.Angular.esproj`).
